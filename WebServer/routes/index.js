...
router.post('/', function(req, res, next) {
    ...
    var req_port = req_Obj.port;

    console.log(req_port);

    req.session.port = req_port;

    if (isCallerMobile(req))
    {
        console.log("mobile client");

        res.render('mobile_stream.html', { title: 'Express'});
    }
        ...
        res.render('desktop_stream.html', {title: 'Express'});
    }
});
